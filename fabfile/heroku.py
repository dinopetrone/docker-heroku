...
def clear_cache(env=None, asset_version='', quick=False, agency_vars={}):
    local(
        'heroku run ./django/manage.py clear_cache -a {}'.format(APP_INFO[env]["heroku_app_name"]))
...
def sync_prod_db(env=None, reset_db=False, agency_vars={}):
    ...
    if reset_db:
        ...
        pass
    local(
        'heroku run ./django/manage.py migrate -a {}'.format(APP_INFO[env]["heroku_app_name"]))
